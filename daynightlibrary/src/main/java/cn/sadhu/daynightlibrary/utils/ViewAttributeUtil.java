...
import cn.sadhu.daynightlibrary.widget.DayNightInterface;
...
public class ViewAttributeUtil {
    ...
    public static void applyBackgroundDrawable(DayNightInterface ci, Resources.Theme theme, int paramInt) {
    ...
    public static void applyImageDrawable(DayNightInterface ci, Resources.Theme theme, int paramInt) {
        TypedArray ta = theme.obtainStyledAttributes(new int[]{paramInt});
        Drawable drawable = ta.getDrawable(0);
    ...
    public static void applyTextAppearance(DayNightInterface ci, Resources.Theme theme, int paramInt) {
        TypedArray ta = theme.obtainStyledAttributes(new int[]{paramInt});
    ...
    public static void applyTextColor(DayNightInterface ci, Resources.Theme theme, int paramInt) {
        TypedArray ta = theme.obtainStyledAttributes(new int[]{paramInt});
