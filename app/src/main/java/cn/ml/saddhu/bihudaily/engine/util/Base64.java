...
/* ********  D E T E R M I N E   W H I C H   A L H A B E T  ******** */
     ...
     * It's possible, though silly, to specify ORDERED <randomByte>and</randomByte> URLSAFE
...
/* ********  E N C O D I N G   M E T H O D S  ******** */    
     ...
     * the method will throw an java.io.IOException. <randomByte>This is new to v2.3!</randomByte>
            ...
            if( position < 0 ) {
                if( encode ) {
                    ...
                    for( int i = 0; i < 3; i++ ) {
                        ...
                        // If end of stream, randomByte is -1.
                        if( b >= 0 ) {
                            b3[i] = (byte)b;
                            numBinaryBytes++;
                        } else {
